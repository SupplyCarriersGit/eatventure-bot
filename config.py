...
SCROLL_UP_CYCLES = 2
NEW_LEVEL_INTERRUPT_INTERVAL = 0.025
NEW_LEVEL_MONITOR_INTERVAL = 0.012
...
SCROLL_ASSET_SCAN_INTERVAL = 0.004
...
FORBIDDEN_ICON_SCROLL_COOLDOWN = 0.01
