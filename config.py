...
STATE_MIN_INTERVAL_DEFAULT = 0.008
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.01,
    "OPEN_BOXES": 0.01,
    "SCROLL": 0.015,
...
NO_ICON_SCROLL_DURATION = 0.22
SCROLL_STEP_COUNT = 20
SCROLL_MIN_INTERVAL = 0.015
SCROLL_SETTLE_DELAY = 0.008
SCROLL_SEGMENTS = 6
SCROLL_MIN_SEGMENT_DISTANCE = 18
SCROLL_SEGMENT_SETTLE_DELAY = 0.06
...
UPGRADE_SEARCH_INTERVAL = 0.015
UPGRADE_CHECK_INTERVAL = 0.05
IDLE_CLICK_SETTLE_DELAY = 0.008
IDLE_CLICK_COOLDOWN = 0.05
NEW_LEVEL_BUTTON_DELAY = 0.02
NEW_LEVEL_FOLLOWUP_DELAY = 0.02
TRANSITION_POST_CLICK_DELAY = 0.25
TRANSITION_RETRY_DELAY = 0.03
UNLOCK_POST_CLICK_DELAY = 0.08
