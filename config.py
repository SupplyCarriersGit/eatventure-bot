...
MOUSE_PRE_CLICK_STABILIZE_BASE = 0.001
...
CAPTURE_CACHE_TTL = 0.02
NEW_LEVEL_RED_ICON_CACHE_TTL = 0.015
<<<<<<< HEAD
UPGRADE_HOLD_DURATION = 4.0
=======
RED_ICON_STABILITY_CACHE_TTL = 0.22
RED_ICON_STABILITY_RADIUS = 14
RED_ICON_STABILITY_MIN_HITS = 2
RED_ICON_STABILITY_MAX_HISTORY = 10
UPGRADE_HOLD_DURATION = 7.0
>>>>>>> 08a9d0a0c2585a2662ab7c592307064befab1d25
UPGRADE_CLICK_INTERVAL = 0.008
SCROLL_UP_CYCLES = 2
NEW_LEVEL_INTERRUPT_INTERVAL = 0.028
NEW_LEVEL_MONITOR_INTERVAL = 0.014
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.25
NO_ICON_SCROLL_UP_COUNT = 6
...
UPGRADE_SEARCH_INTERVAL = 0.022
UPGRADE_CHECK_INTERVAL = 0.045
IDLE_CLICK_SETTLE_DELAY = 0.006
IDLE_CLICK_COOLDOWN = 0.09
NEW_LEVEL_BUTTON_DELAY = 0.03
NEW_LEVEL_FOLLOWUP_DELAY = 0.02
TRANSITION_POST_CLICK_DELAY = 0.35
TRANSITION_RETRY_DELAY = 0.05
UNLOCK_POST_CLICK_DELAY = 0.12
WAIT_UNLOCK_RETRY_DELAY = 0.07
FORBIDDEN_ICON_MAX_SCROLLS = 3
FORBIDDEN_ICON_SCROLL_DURATION = 0.2
FORBIDDEN_ICON_SCROLL_COOLDOWN = 0.012
