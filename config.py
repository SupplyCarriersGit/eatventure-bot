...
STATS_UPGRADE_CLICK_DELAY = 0.008
...
NEW_LEVEL_MONITOR_INTERVAL = 0.008
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.2
NO_ICON_SCROLL_UP_COUNT = 5
NO_ICON_SCROLL_DOWN_COUNT = 9
...
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.008,
    "OPEN_BOXES": 0.008,
    "SCROLL": 0.01,
}
SCROLL_DURATION = 0.15
NO_ICON_SCROLL_DURATION = 0.15
SCROLL_STEP_COUNT = 20
SCROLL_MIN_INTERVAL = 0.01
SCROLL_SETTLE_DELAY = 0.005
SCROLL_SEGMENTS = 6
SCROLL_MIN_SEGMENT_DISTANCE = 18
SCROLL_SEGMENT_SETTLE_DELAY = 0.035
SCROLL_ASSET_SCAN_INTERVAL = 0.008
SCROLL_RED_ICON_MIN_DISTANCE = 20
SCROLL_RED_ICON_THRESHOLD_DROP = 0.04
SCROLL_RED_ICON_MIN_MATCHES = 1
SCROLL_DISTANCE_RATIO = 0.45
...
UPGRADE_SEARCH_INTERVAL = 0.01
UPGRADE_CHECK_INTERVAL = 0.02
IDLE_CLICK_SETTLE_DELAY = 0.005
IDLE_CLICK_COOLDOWN = 0.02
NEW_LEVEL_BUTTON_DELAY = 0.01
NEW_LEVEL_FOLLOWUP_DELAY = 0.01
TRANSITION_POST_CLICK_DELAY = 0.15
TRANSITION_RETRY_DELAY = 0.015
UNLOCK_POST_CLICK_DELAY = 0.05
WAIT_UNLOCK_RETRY_DELAY = 0.03
...
AI_LEARNING_MIN_CLICK_DELAY = 0.03
AI_LEARNING_MAX_CLICK_DELAY = 0.12
AI_LEARNING_MIN_MOVE_DELAY = 0.0015
AI_LEARNING_MAX_MOVE_DELAY = 0.012
AI_LEARNING_MIN_UPGRADE_INTERVAL = 0.005
AI_LEARNING_MAX_UPGRADE_INTERVAL = 0.013
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.008
