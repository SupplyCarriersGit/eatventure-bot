...
MOUSE_DOWN_UP_DELAY = 0.005
DOUBLE_CLICK_DELAY = 0.03
...
CAPTURE_CACHE_TTL = 0.05
UPGRADE_HOLD_DURATION = 4.0
UPGRADE_CLICK_INTERVAL = 0.008
SCROLL_UP_CYCLES = 2
NEW_LEVEL_INTERRUPT_INTERVAL = 0.15
...
SCROLL_DURATION = 0.22
UPGRADE_SEARCH_INTERVAL = 0.05
UPGRADE_CHECK_INTERVAL = 0.12
IDLE_CLICK_SETTLE_DELAY = 0.02
NEW_LEVEL_BUTTON_DELAY = 0.08
NEW_LEVEL_FOLLOWUP_DELAY = 0.05
TRANSITION_POST_CLICK_DELAY = 0.7
TRANSITION_RETRY_DELAY = 0.12
UNLOCK_POST_CLICK_DELAY = 0.3
WAIT_UNLOCK_RETRY_DELAY = 0.2
